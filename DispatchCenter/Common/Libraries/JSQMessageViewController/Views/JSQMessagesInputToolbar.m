...
- (void)toggleSendButtonEnabled
{
    ...
    if (self.sendButtonOnRight) {
        ...
        if (hasText) {
            [self.contentView.rightBarButtonItem setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [self.contentView.rightBarButtonItem setTitleColor:[UIColor blackColor] forState:UIControlStateSelected];
            self.contentView.rightBarButtonItem.backgroundColor  = [UIColor colorFromHexString:@"#febf0f"];
        } else {
            self.contentView.rightBarButtonItem.backgroundColor  = [UIColor clearColor];
